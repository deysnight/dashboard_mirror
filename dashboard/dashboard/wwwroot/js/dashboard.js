...
function check_if_widget_exist() {
    ...
    if (Dashboard_Data.hasOwnProperty("overwatch") == true)
        $("#widget_01_overwatch").css("background-color", "rgb(230, 230, 230)");
} 
...
function read_json()
{
    ...
    if (Dashboard_Data.config.ss.s06 == true) {
        $("#overwatch_checkbox").attr("checked", "checked");
    }
    else
    ...
    if (Dashboard_Data.hasOwnProperty("overwatch") == true) {
        var battletag = Dashboard_Data.overwatch.battletag;
        var timer = Dashboard_Data.overwatch.timer;
        var widg_n = Dashboard_Data.overwatch.name;
...
$("#checkmark_overwatch").click(function () {
...
$('#checkmark_overwatch').click(function () {
    ...
    var $checks = $('input:checkbox[name=overwatch_check]');
...
document.getElementById('meteo_service').onclick = function(event) {
    ...
    document.getElementById('overwatch_intel').style.display = "none";
}
...
document.getElementById('overwatch_service').onclick = function(event) {
    document.getElementById('meteo_intel').style.display = "none";
    document.getElementById('steam_intel').style.display = "none";
    document.getElementById('twitch_intel').style.display = "none";
    document.getElementById('crypto_intel').style.display = "none";
    document.getElementById('youtube_intel').style.display = "none";
    document.getElementById('overwatch_intel').style.display = "block";
}
...
function show_widg (){
    ...
    var checkbox = document.getElementById("overwatch_checkbox");
    if (checkbox.checked == true) {
        input = $(
            '<div id="widget_modal_overwatch_data">' +
                '<p class="widget_modal_title">Widget Overwatch</p>' +
                '<div class="widget_in_modal">' +
                    '<p class="widget_modal" id="widget_01_overwatch" onclick="display_overwatch_modal()">Informations sur un profil Overwatch</p>' +
                '</div>' +
            '</div>'
        );
        $("#overwatch_widget_modal").html(input);
    }
}
...
function display_overwatch_modal() {
    if (Dashboard_Data.hasOwnProperty("overwatch") == true) {
        return false;
    }

    modal_widget.style.display = "none";
    document.getElementById("ConfigOverwatch").style.display = "block";
}

$('.CloseConfigOverwatchCancel01').click(function () {
    $("#name_overwatch01").val("");
    $("#id_overwatch01").val("");
    $("#timer_overwatch01").val("");
    document.getElementById("ConfigOverwatch").style.display = "none";
});

$('.CloseConfigOverwatchValidate01').click(function () {
    $("#widget_01_overwatch").css("background-color", "rgb(230, 230, 230)");
    if ($("#name_overwatch01").val() == "" || $("#id_overwatch01").val() == "" || $("#timer_overwatch01").val() == "")
        return false;
    if ($.isNumeric($("#timer_overwatch01").val()) == false)
        return false;
...
function validate_youtube03_widget_reconfig_modal() {
    if ($("#reconfig_name_youtube03").val() == "" || $("#reconfig_youtube_video_03").val() == "" || $("#reconfig_nb_comment").val() == "" || $("#reconfig_timer_youtube03").val() == "")
        return false;
    if ($.isNumeric($("#reconfig_timer_youtube03").val()) == false || $.isNumeric($("#reconfig_nb_comment").val()) == false)
        return false;
...
function display_overwatch_widget_reconfig_modal()
{
    document.getElementById("reconfig_overwatch").style.display = "block";
}

function cancel_overwatch_widget_reconfig_modal() {
...
function validate_overwatch_widget_reconfig_modal() {
    if ($("#reconfig_name_overwatch01").val() == "" || $("#reconfig_id_overwatch01").val() == "" || $("#reconfig_timer_overwatch01").val() == "")
        return false;
    if ($.isNumeric($("#reconfig_timer_overwatch01").val()) == false)
        return false;
...
function Display_Meteo_Widget() {
    ...
    $("#overwatch_disp").css("display","none");
}
...
function Display_Overwatch_Widget() {
    $("#meteo_disp").css("display","none");
    $("#steam01_disp").css("display","none");
    $("#steam02_disp").css("display","none");
    $("#twitch01_disp").css("display","none");
    ...
    $("#youtube02_disp").css("display","none");
    $("#youtube03_disp").css("display","none");
    $("#overwatch_disp").css("display","block");
}

$("#widg_mete").on("click", "li", function(e) {
    $("#widg_mete li").addClass("select").siblings().removeClass("select");
    $("#widg_steam01 li").removeClass("select");
    $("#widg_steam02 li").removeClass("select");
    $("#widg_twitch01 li").removeClass("select");
    $("#widg_twitch02 li").removeClass("select");
    $("#widg_crypto li").removeClass("select");
...
$("#widg_steam01").on("click", "li", function(e) {
    $("#widg_steam01 li").addClass("select").siblings().removeClass("select");
    $("#widg_mete li").removeClass("select");
    $("#widg_steam02 li").removeClass("select");
    $("#widg_twitch01 li").removeClass("select");
    $("#widg_twitch02 li").removeClass("select");
    $("#widg_crypto li").removeClass("select");
...
$("#widg_steam02").on("click", "li", function(e) {
    $("#widg_steam02 li").addClass("select").siblings().removeClass("select");
    $("#widg_mete li").removeClass("select");
    $("#widg_steam01 li").removeClass("select");
    $("#widg_twitch01 li").removeClass("select");
    $("#widg_twitch02 li").removeClass("select");
...
$("#widg_twitch01").on("click", "li", function(e) {
    $("#widg_twitch01 li").addClass("select").siblings().removeClass("select");
    $("#widg_mete li").removeClass("select");
    $("#widg_steam01 li").removeClass("select");
    $("#widg_steam02 li").removeClass("select");
    $("#widg_twitch02 li").removeClass("select");
...
$("#widg_twitch02").on("click", "li", function(e) {
    $("#widg_twitch02 li").addClass("select").siblings().removeClass("select");
    $("#widg_mete li").removeClass("select");
    $("#widg_steam01 li").removeClass("select");
    $("#widg_steam02 li").removeClass("select");
    $("#widg_twitch01 li").removeClass("select");
...
$("#widg_crypto").on("click", "li", function(e) {
    $("#widg_crypto li").addClass("select").siblings().removeClass("select");
    $("#widg_mete li").removeClass("select");
    $("#widg_steam01 li").removeClass("select");
    $("#widg_steam02 li").removeClass("select");
    $("#widg_twitch01 li").removeClass("select");
...
$("#widg_youtube01").on("click", "li", function(e) {
    $("#widg_youtube01 li").addClass("select").siblings().removeClass("select");
    $("#widg_mete li").removeClass("select");
    $("#widg_steam01 li").removeClass("select");
    $("#widg_steam02 li").removeClass("select");
    $("#widg_twitch01 li").removeClass("select");
...
$("#widg_youtube02").on("click", "li", function(e) {
    $("#widg_youtube02 li").addClass("select").siblings().removeClass("select");
    $("#widg_steam02 li").addClass("select").siblings().removeClass("select");
    $("#widg_mete li").removeClass("select");
    $("#widg_steam01 li").removeClass("select");
    $("#widg_steam02 li").removeClass("select");
...
$("#widg_youtube03").on("click", "li", function(e) {
    $("#widg_youtube03 li").addClass("select").siblings().removeClass("select");
    $("#widg_mete li").removeClass("select");
    $("#widg_steam01 li").removeClass("select");
    $("#widg_steam02 li").removeClass("select");
    $("#widg_twitch01 li").removeClass("select");
...
$("#widg_overwatch").on("click", "li", function(e) {
    $("#widg_overwatch li").addClass("select").siblings().removeClass("select");
    $("#widg_mete li").removeClass("select");
    $("#widg_steam01 li").removeClass("select");
    $("#widg_steam02 li").removeClass("select");
    $("#widg_twitch01 li").removeClass("select");
